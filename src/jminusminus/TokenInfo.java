...
enum TokenKind {
    ...
    //adding a new Reserved words
    BREAK("break"), CASE("case"), CATCH("catch"), CONTINUE("continue"), 
    DEFAULT("default"), DO("do"), DOUBLE("double"), FINAL("final"),
    FINALLY("finally"), FOR("for"), IMPLEMENTS("implements"), 
    ...
    DIV("/"), REM("%"), LS("<<") , RS(">>") , LRS(">>>"), INCL("|"), EXCL("^"),
    AND("&"), COMPL ("~"), QUESTION("?"), NOTEQUAL ("!="), DIV_ASSIGN("/="), 
    MINUS_ASSIGN("-="), MUL_ASSIGN("*="), REM_ASSIGN("%="), RS_ASSIGN(">>="),
    LRS_ASSIGN(">>>="), GE(">="), LS_ASSIGN("<<="), LT("<"), EXCL_ASSIGN("^="),
    INCL_ASSIGN("|="), LOR("||"), AND_ASSIGN("&="),
    ...
    DOUBLE_LITERAL("<DOUBLE_LITERAL>"), CHAR_LITERAL("<CHAR_LITERAL>"), 
