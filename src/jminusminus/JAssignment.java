...
class JMulAssignOp extends JAssignment {
    ...
    public JMulAssignOp(int line, JExpression lhs, JExpression rhs) {
        super(line, "*=", lhs, rhs);
    }
...
class JMinusAssignOp extends JAssignment {
    ...
    /**
     * Analyzes the lhs and rhs, rewrites rhs as lhs - rhs
     * 
     * @param context
     *            context in which names are resolved.
     * @return the analyzed (and possibly rewritten) AST subtree.
    ...
    /**
     * Code generation for -= involves, generating code for loading any
     * necessary l-value onto the stack
     * loading the r-value, for (unless a statement) copying the r-value to its
     * proper place on the stack, and for doing the store.
     * 
     * @param output
 ...
 * a rhs.
 */
class JLogicalRightShiftAssignOp extends JAssignment {
    ...
    public JLogicalRightShiftAssignOp(int line, JExpression lhs, JExpression rhs) {
        super(line, ">>>=", lhs, rhs);
    }
 ...
 * a rhs.
 */
class JExclusiveAssignOp extends JAssignment {
    ...
    public JExclusiveAssignOp(int line, JExpression lhs, JExpression rhs) {
        super(line, "^=", lhs, rhs);
    }
 ...
 * a rhs.
 */
class JInclusiveAssignOp extends JAssignment {
    ...
    public JInclusiveAssignOp(int line, JExpression lhs, JExpression rhs) {
        super(line, "|=", lhs, rhs);
    }
